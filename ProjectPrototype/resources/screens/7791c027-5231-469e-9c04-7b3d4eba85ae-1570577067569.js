jQuery("#simulation")
  .on("click", ".s-7791c027-5231-469e-9c04-7b3d4eba85ae .click", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-7791c027-5231-469e-9c04-7b3d4eba85ae #s-EditBtn_1 > .backgroundLayer": {
                      "attributes": {
                    ...
                    "#s-7791c027-5231-469e-9c04-7b3d4eba85ae #s-EditBtn_1": {
                      "attributes-ie": {
  ...
  .on("pageload", ".s-7791c027-5231-469e-9c04-7b3d4eba85ae .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("panelactive", ".s-7791c027-5231-469e-9c04-7b3d4eba85ae .panelactive", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-Tabbar_Max")) {
      cases = [
        {
          "blocks": [
            {
