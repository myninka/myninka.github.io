jQuery("#simulation")
  .on("click", ".s-793ca64f-ff47-4923-bcc6-ad56fe4619ee .click", function(event, data) {
    ...
    if(jFirer.is("#s-Rectangle_26")) {
              ...
              "actions": [
                {
                  "action": "jimShow",
                  "parameter": {
                    "target": [ "#s-AppBar_Main","#s-Reports_All" ]
                  },
                  "exectype": "serial",
                  "delay": 0
                }
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-ModeSwitchBtn_1")) {
      cases = [
        {
          "blocks": [
            {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/793ca64f-ff47-4923-bcc6-ad56fe4619ee"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("click", ".s-793ca64f-ff47-4923-bcc6-ad56fe4619ee .toggle", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("dragstart", ".s-793ca64f-ff47-4923-bcc6-ad56fe4619ee .dragstart", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("focusin", ".s-793ca64f-ff47-4923-bcc6-ad56fe4619ee .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-793ca64f-ff47-4923-bcc6-ad56fe4619ee #s-Category_5 > .backgroundLayer": {
                      "attributes": {
  ...
  .on("focusout", ".s-793ca64f-ff47-4923-bcc6-ad56fe4619ee .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("panelactive", ".s-793ca64f-ff47-4923-bcc6-ad56fe4619ee .panelactive", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-Report_Loan")) {
      cases = [
        {
          "blocks": [
            {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-Report_Account")) {
      cases = [
        {
          "blocks": [
            {
