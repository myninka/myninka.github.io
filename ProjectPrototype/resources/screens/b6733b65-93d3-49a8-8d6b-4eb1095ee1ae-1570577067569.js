jQuery("#simulation")
  .on("click", ".s-b6733b65-93d3-49a8-8d6b-4eb1095ee1ae .click", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-b6733b65-93d3-49a8-8d6b-4eb1095ee1ae #s-Image_14 > svg": {
                      "attributes": {
                        "overlay": "#666666"
                      }
                    }
  ...
  .on("click", ".s-b6733b65-93d3-49a8-8d6b-4eb1095ee1ae .toggle", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("dragstart", ".s-b6733b65-93d3-49a8-8d6b-4eb1095ee1ae .dragstart", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("keyup.jim", ".s-b6733b65-93d3-49a8-8d6b-4eb1095ee1ae .keyup", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("focusin", ".s-b6733b65-93d3-49a8-8d6b-4eb1095ee1ae .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-b6733b65-93d3-49a8-8d6b-4eb1095ee1ae #s-Input_2 > .backgroundLayer": {
                      "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-b6733b65-93d3-49a8-8d6b-4eb1095ee1ae #s-Category_5 > .backgroundLayer": {
                      "attributes": {
  ...
  .on("focusout", ".s-b6733b65-93d3-49a8-8d6b-4eb1095ee1ae .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
